#!/usr/bin/env python3
"""
Clean startup script for Elizabeth Andrews Bank Statement Parser API
This script starts the API without processing any existing PDFs
"""
...
if __name__ == "__main__":
    ...
    print("\n⚡ Starting server (no PDF processing on startup)...")
